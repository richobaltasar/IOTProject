...
END
GO
PRINT N'Creating [dbo].[SP_BukuData_Get_ById]...';
...
AS
	...
	where IdBook = @Id
GO
PRINT N'Creating [dbo].[SP_BukuData_GetSearch]...';
...
GO
PRINT N'Creating [dbo].[SP_BukuData_Save]...';
...
GO
PRINT N'Creating [dbo].[SP_CariBuku_AddCart]...';
...
GO
PRINT N'Creating [dbo].[SP_CariBuku_GetSearch]...';
...
GO
PRINT N'Creating [dbo].[SP_CariBuku_UpdateCart]...';
...
AS
	...
	select @Title Title, @Message Message, @MStatus Status, @Id Id
GO
PRINT N'Creating [dbo].[SP_DetailHarian_GetSearch]...';
...
GO
PRINT N'Creating [dbo].[SP_FormPeminjaman_GetById]...';
...
GO
PRINT N'Creating [dbo].[SP_KonfirmasiTransaksi_Bayar]...';
...
GO
PRINT N'Creating [dbo].[SP_KonfirmasiTransaksi_DetailGet]...';
...
AS
	...
	where IdTrx = @Id
GO
PRINT N'Creating [dbo].[SP_KonfirmasiTransaksi_GetById]...';
...
AS
	...
	IdTrx = @Id
GO
PRINT N'Creating [dbo].[SP_KonfirmasiTransaksi_GetSearch]...';
...
GO
PRINT N'Creating [dbo].[SP_PengembalianBuku_Search]...';
...
GO
PRINT N'Creating [dbo].[SP_PengembalianBuku_Submit]...';
...
GO
PRINT N'Creating [dbo].[SP_SummaryHarian_GetSearch]...';
...
where --q.TanggalTransaksi 
	...
	and replace(CONVERT(VARCHAR(10), CONVERT(date, replace(left(@TglTrxUntil,10),'/','-'), 105), 23),'-','')
GO
PRINT N'Creating [dbo].[SP_TransaksiPeminjaman_Checkout]...';
...
GO
PRINT N'Creating [dbo].[SP_TransaksiPeminjaman_Del]...';
...
select @Title Title, @Message Message, @MStatus Status, @Id Id
GO
PRINT N'Creating [dbo].[SP_TransaksiPeminjaman_Get]...';
...
AS
	select
		...
		left join UserData c on c.id = a.IdUser_Penyewa
GO
PRINT N'Creating [dbo].[SP_TransaksiPeminjaman_GetById]...';
...
AS
	...
	where a.Id = @Id
GO
PRINT N'Creating [dbo].[SP_TransaksiTransaksiPeminjamanBuku_GetSearch]...';
